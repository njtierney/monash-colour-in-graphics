...
```{r pals}
loadd(bom_standard_palette)
loadd(bom_viridis_palette)
```
...
check_color_blindness(bom_standard_palette)
```
]
...
check_color_blindness(bom_viridis_palette)
```
]
...
```{r show-rainbow-specplot, echo = TRUE, out.width = "60%"}
...
```{r show-rainbow-hclplot, echo = TRUE, out.width = "60%"}
...
```{r show-rainbow-specplot-protan, echo = TRUE, out.width = "60%"}
...
```{r show-rainbow-protan-hclplot, echo = TRUE, out.width = "60%"}
...
```{r show-rainbow-demoplot, echo = TRUE, out.width = "60%"}
...
```{r show-rainbow-protan-demoplot, echo = TRUE, out.width = "60%"}
...
.pull-left[
```{r show-rainbow-viridis-specplot-1, echo = TRUE}
rainbow(n = 20) %>% 
  specplot()
```
]
...
.pull-right[
```{r show-rainbow-viridis-specplot-2, echo = TRUE}
pals::viridis(n = 20) %>% 
  specplot()
```
]
...
.pull-left[
```{r show-rainbow-viridis-specplot-protan-1, echo = TRUE}
rainbow(n = 20) %>% 
  protan() %>% 
  specplot()
```
...
.pull-right[
```{r show-rainbow-viridis-specplot-protan-2, echo = TRUE}
pals::viridis(n = 20) %>% 
  protan() %>% 
  specplot()
```
...
.pull-left[
```{r show-rainbow-viridis-hclplot-1, echo = TRUE}
rainbow(n = 20) %>% 
  hclplot()
```
]
...
.pull-right[
```{r show-rainbow-viridis-hclplot-2, echo = TRUE}
pals::viridis(n = 20) %>% 
  hclplot()
```
]
...
.pull-left[
```{r show-rainbow-viridis-hclplot-protan-1, echo = TRUE}
rainbow(n = 20) %>% 
  protan() %>% 
  hclplot()
```
...
.pull-right[
```{r show-rainbow-viridis-hclplot-protan-2, echo = TRUE}
pals::viridis(n = 20) %>% 
  protan() %>% 
  hclplot()
```
...
.pull-left[
```{r show-rainbow-viridis-demoplot-1, echo = TRUE}
rainbow(n = 20) %>% 
  demoplot()
```
]
...
.pull-right[
```{r show-rainbow-viridis-demoplot-2, echo = TRUE}
pals::viridis(n = 20) %>% 
  demoplot()
```
]
...
.pull-left[
```{r show-rainbow-viridis-demoplot-protan-show-1, echo = TRUE}
rainbow(n = 20) %>% 
  protan() %>% 
  demoplot()
```  
...
.pull-right[
```{r show-rainbow-viridis-demoplot-protan-show-2, echo = TRUE}
pals::viridis(n = 20) %>% 
  protan() %>% 
  demoplot()
```
